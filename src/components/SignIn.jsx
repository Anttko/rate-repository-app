...
const SignInFormik = ({ onSubmit }) => {
  return (
    <View style={styles.container}>
      <FormikTextInput name="username" placeholder="username" style={styles.formInputUser} />
      <FormikTextInput name="password" placeholder="password" style={styles.formInputPass} />
      <Pressable
